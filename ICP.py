...
def doICP(model_pts_np, pred_pts_np, SigmaFactor=5, threshold=1000, isViz=False):
    model_pts = o3d.geometry.PointCloud()
    model_pts.points = o3d.utility.Vector3dVector(model_pts_np)
    model_pts_orig = model_pts
    model_pts_orig_np = np.asarray(model_pts_orig.points)
    pred_pts = o3d.geometry.PointCloud()
    pred_pts.points = o3d.utility.Vector3dVector(pred_pts_np)
    ...
    model_pts = o3d.geometry.PointCloud()
    model_pts.points = o3d.utility.Vector3dVector(model_pts_np)
    model_pts_orig = o3d.geometry.PointCloud()
    model_pts_orig.points = o3d.utility.Vector3dVector(model_pts_orig_np)
    # model_pca = PCA(model_pts_np)
